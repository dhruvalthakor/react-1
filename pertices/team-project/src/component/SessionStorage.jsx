                                        ...
                                        <div className="modal-content">
                                            ...
                                            <div className="modal-footer">
                                                <button type="button" data-bs-dismiss="modal"
                                                    ...
                                                    onClick={() => handleTaskEdit(item,item.id)}
                                                >
                                                    Edit
                                                </button>

                                                <button type="button" data-bs-dismiss="modal" className="btn btn-primary" onClick={() => handleSaveTask(item,item.id)}>Save changes</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
